  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-end justify-between">
        <div>
          <h1 className="text-[22px] font-bold text-gray-900 tracking-tight">MTD Sales Overview</h1>
          <p className="text-[13px] text-gray-400 mt-0.5 font-medium">Month-to-date sales performance with daily breakdown</p>
        </div>
      </div>
